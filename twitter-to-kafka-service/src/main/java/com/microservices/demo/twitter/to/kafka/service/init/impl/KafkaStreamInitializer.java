...
public class KafkaStreamInitializer implements StreamInitializer {
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(KafkaStreamInitializer.class);
    ...
    public void init() {
        ...
        LOGGER.info("Topics {} are ready!", kafkaConfigData.getTopicNamesToCreate().toArray());
    }
}
